...
static const std::map<std::pair<SKILLCHAIN_ELEMENT, SKILLCHAIN_ELEMENT>, SKILLCHAIN_ELEMENT> skillchain_map = {
    ...
    // FIRE + LIGHT = FUSION
    { { SC_LIQUEFACTION, SC_TRANSFIXION }, SC_FUSION },
    { { SC_TRANSFIXION, SC_LIQUEFACTION }, SC_FUSION },

    //EARTH + DARK = GRAVITATION
    { { SC_SCISSION, SC_COMPRESSION }, SC_GRAVITATION },
    { { SC_COMPRESSION, SC_SCISSION }, SC_GRAVITATION },

    //WATER + ICE = DISTORTION
    { { SC_REVERBERATION, SC_INDURATION }, SC_DISTORTION },
    { { SC_INDURATION, SC_REVERBERATION }, SC_DISTORTION },

    //WIND + THUNDER = FRAGMENTATION
    { { SC_DETONATION, SC_IMPACTION }, SC_FRAGMENTATION },
    { { SC_IMPACTION, SC_DETONATION }, SC_FRAGMENTATION },
    ...
    //ICE + FIRE = FIRE
    { { SC_INDURATION, SC_LIQUEFACTION }, SC_LIQUEFACTION },

    //WIND + ICE = ICE
    { { SC_DETONATION, SC_INDURATION }, SC_INDURATION },

    //EARTH + WIND = WIND
    { { SC_SCISSION, SC_DETONATION }, SC_DETONATION },

    //THUNDER + EARTH = EARTH
    { { SC_IMPACTION, SC_SCISSION }, SC_SCISSION },

    //WATER + THUNDER = THUNDER
    { { SC_REVERBERATION, SC_IMPACTION }, SC_IMPACTION },

    //FIRE + WATER = WATER
    { { SC_LIQUEFACTION, SC_REVERBERATION }, SC_REVERBERATION },

    //FIRE + WIND = THUNDER
    { { SC_LIQUEFACTION, SC_DETONATION }, SC_IMPACTION },
    { { SC_DETONATION, SC_LIQUEFACTION }, SC_IMPACTION },

    //WATER + EARTH = ICE
    { { SC_REVERBERATION, SC_SCISSION }, SC_INDURATION },
    { { SC_SCISSION, SC_REVERBERATION }, SC_INDURATION },

    //LIGHTNING + DARK = DARK + LIGHTNING
    { { SC_IMPACTION, SC_COMPRESSION }, SC_COMPRESSION },
    { { SC_COMPRESSION, SC_IMPACTION }, SC_IMPACTION },

    //ICE + LIGHT = LIGHT + ICE
    { { SC_INDURATION, SC_TRANSFIXION }, SC_TRANSFIXION },
    { { SC_TRANSFIXION, SC_INDURATION }, SC_INDURATION },
