...
static const std::map<std::pair<SKILLCHAIN_ELEMENT, SKILLCHAIN_ELEMENT>, SKILLCHAIN_ELEMENT> skillchain_map = {
    ...
    //ICE + FIRE = FIRE
    { { SC_LIQUEFACTION, SC_INDURATION }, SC_LIQUEFACTION },

    //WIND + ICE = ICE
    { { SC_INDURATION, SC_DETONATION }, SC_INDURATION },

    //EARTH + WIND = WIND
    { { SC_DETONATION, SC_SCISSION }, SC_DETONATION },

    //THUNDER + EARTH = EARTH
    { { SC_SCISSION, SC_IMPACTION }, SC_SCISSION },

    //WATER + THUNDER = THUNDER
    { { SC_IMPACTION, SC_REVERBERATION }, SC_IMPACTION },

    //FIRE + WATER = WATER
    { { SC_REVERBERATION, SC_LIQUEFACTION }, SC_REVERBERATION },
