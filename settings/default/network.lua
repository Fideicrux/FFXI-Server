...
xi.settings.network =
{
    ...
    SQL_PORT     = 3306,
    SQL_LOGIN    = 'lsb_xi',
    SQL_PASSWORD = 'Daisy_4061385',
    SQL_DATABASE = 'ffxi_db',

    LOGIN_DATA_IP   = '167.114.3.244',
    LOGIN_DATA_PORT = 54230,
    LOGIN_VIEW_IP   = '167.114.3.244',
    LOGIN_VIEW_PORT = 54001,
    LOGIN_AUTH_IP   = '167.114.3.244',
    LOGIN_AUTH_PORT = 54231,
    LOGIN_CONF_IP   = '167.114.3.244',
