...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    -- Updated formula to match Thunder IV Spell (Base: 812, Multiplier: 2.0) * 1.33
    local damage = math.floor(798 + (pet:getStat(xi.mod.INT) * 10.64 - target:getStat(xi.mod.INT)))
