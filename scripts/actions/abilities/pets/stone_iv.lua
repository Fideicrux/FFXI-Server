...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    -- Updated formula to match Stone IV Spell (Base: 572, Multiplier: 2.0) * 1.33
    local damage = math.floor(532 + (pet:getStat(xi.mod.INT) * 10.64 - target:getStat(xi.mod.INT)))
