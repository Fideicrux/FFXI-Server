...
abilityObject.onPetAbility = function(target, pet, petskill, summoner, action)
    ...
    -- Updated formula to match Thunder II Spell (Base: 267, Multiplier: 1.0) * 1.33
    local damage = math.floor(266 + (pet:getStat(xi.mod.INT) * 2.33 - target:getStat(xi.mod.INT)))
