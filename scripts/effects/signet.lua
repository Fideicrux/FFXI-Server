...
effectObject.onEffectGain = function(target, effect)
    ...
    target:addLatent(xi.latent.SIGNET_BONUS, 0, xi.mod.ACC, 15)
    target:addLatent(xi.latent.SIGNET_BONUS, 0, xi.mod.MACC, 15)
end
...
effectObject.onEffectLose = function(target, effect)
    ...
    target:delLatent(xi.latent.SIGNET_BONUS, 0, xi.mod.ACC, 15)
    target:delLatent(xi.latent.SIGNET_BONUS, 0, xi.mod.MACC, 15)
end
